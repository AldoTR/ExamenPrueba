...
describe('UiComponent', () => {
  ...
  it('Should set numero model through ngModel', async() => {
    ...
    fixture.detectChanges();
    const inputElement = fixture.debugElement.query(By.css('input[name="numero"]')).nativeElement;
  ...
  it('Should set valorA model through ngModel', async() => {
    ...
    await fixture.whenStable();
    fixture.detectChanges();
    const inputElement = fixture.debugElement.query(By.css('input[name="valorA"]')).nativeElement;
  ...
  it('Should set valorB model through ngModel', async() => {
    ...
    await fixture.whenStable();
    fixture.detectChanges();
    const inputElement = fixture.debugElement.query(By.css('input[name="valorB"]')).nativeElement;
  ...
  it('should add numero in the arrayX when i click the Calcular button ', () => {
    ...
    let siguienteButton = fixture.debugElement.query(By.css('button'));
